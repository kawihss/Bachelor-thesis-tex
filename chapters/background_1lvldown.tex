...
%\subsection{Trajectory prediction in maritime/AIS}%core SOTA werde das zusammenfassen mit related work am ende des kapitels?
...
\subsection{Sequence-to-Sequence Models}   
    ...
    \paragraph{x-LSTM} \me{only really important to motivate tirex. maybe too detailed here}
...
\begin{comment} % not used, not relevant here 
    
\paragraph{NAS Problem}
...
\subsubsection{Search strategies and Pruning}
