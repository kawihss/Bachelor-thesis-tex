...
First, physical integrity checks are applied, where invalid data points violating fixed bounds are discarded and tracks with fewer than 100 points are removed.  
