...
\title{Deep Learning-based Motion Models for \\Multi-Target Tracking of Inland Vessels \\using AIS Data}
...
External daily Supervisor (IRT): Tim Rehbronn\\
Internal daily supervisor (AIM): Wadie Skaf\\
}
...
\listofalgorithms
\todo{I want a List of Abbrevations. Needed for AutoML and Vessel specific terms so everyone understands}
